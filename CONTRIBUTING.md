# Contributing to Flight Cloud Client GUI

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Cloud Client GUI? Welcome! Please read this
...
You can help Flight Cloud Client GUI by helping others who use it and need support.

## Analyse Issues

Analysing issue reports can be a lot of effort. Any help is welcome!
Go to [the GitHub issue tracker](https://github.com/openflighthpc/flight-cloud-client-gui/issues?state=open)
...
If you find a bug - behaviour of Flight Cloud Client GUI code or documentation
...
[GitHub issue tracker for Flight Cloud Client GUI](https://github.com/openflighthpc/flight-cloud-client-gui/issues/new)
to report the issue.
...
We want to improve the quality of Flight Cloud Client GUI and good bug reports are
...
Flight Cloud Client GUI is Open Source and comes without warranty.
...
Flight Cloud Client GUI in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Cloud Client GUI and really improve it. The more
...
applied to Flight Cloud Client GUI itself.

In particular you need to agree to the Contributor License Agreement,
which can be [found
here](https://www.clahub.com/agreements/openflighthpc/flight-cloud-client-gui). This
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Cloud Client GUI developers also have their regular
